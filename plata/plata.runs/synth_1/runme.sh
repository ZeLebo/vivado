...
HD_PWD='C:/Users/p.bortnikov/plata/plata.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plata.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source plata.tcl
