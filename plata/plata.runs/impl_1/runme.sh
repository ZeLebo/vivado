...
HD_PWD='C:/Users/p.bortnikov/plata/plata.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log plata.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source plata.tcl -notrace
